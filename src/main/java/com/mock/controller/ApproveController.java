...
import com.mock.entities.Claim;
import com.mock.entities.StaffProject;
import com.mock.entities.Status;
import com.mock.service.ClaimService;
...
public class ApproveController {
    ...
    @GetMapping("/approve/cancel111")
    public String cancelClaim111(
            @RequestParam String claimID
    ) {
        Claim claim = claimService.getOne(Integer.parseInt(claimID));
        claim.setStatus(Status.CANCELLED);
