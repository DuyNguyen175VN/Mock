...
public class StaffController {
    ...
    public String update(
        ...
        if (staff.getEmail().equals(staffDB.getEmail())) {
            ...
            if (staffService.findByEmail(staff.getEmail()) != null) {
                bindingResult.addError(
                        new FieldError( "staff", "email", staff.getEmail(), false, null, null, "Invalid email")
                );
            }
        }
        ...
        if (staff.getUsername().equals(staffDB.getUsername())) {
            ...
            if (staffService.findByUsername(staff.getUsername()) != null || staff.getUsername().isEmpty()) {
                bindingResult.addError(
                        new FieldError( "staff", "username", staff.getUsername(), false, null, null, "Invalid username")
                );
            }
        }
        ...
        if (staff.getPhoneNumber().equals(staffDB.getPhoneNumber())) {
            ...
            if (staffService.findByPhoneNumber(staff.getPhoneNumber()) != null || staff.getPhoneNumber().isEmpty()) {
                bindingResult.addError(
                        new FieldError( "staff", "phoneNumber", staff.getPhoneNumber(), false, null, null, "Invalid phone number")
                );
            }
        }
