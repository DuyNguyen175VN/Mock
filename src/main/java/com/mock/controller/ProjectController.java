...
import com.mock.dto.ProjectDTO;
import com.mock.dto.StaffProjectDTO;
import com.mock.entities.Project;
import com.mock.entities.Role;
import com.mock.entities.Staff;
import com.mock.entities.StaffProject;
import com.mock.service.ProjectService;
import com.mock.service.StaffProjectService;
import com.mock.service.StaffService;
...
public class ProjectController {
    ...
    public String updateProject(
        ...
        if (projectDTO.getProjectName().equals(projectDB.getProjectName())) {
            ...
            if (projectService.findByProjectName(projectDTO.getProjectName()) != null || projectDTO.getProjectName().isEmpty()) {
                bindingResult.addError(
                        new FieldError("projectDTO", "projectName", projectDTO.getProjectName(), false, null, null, "Invalid project name")
                );
            }
        }
